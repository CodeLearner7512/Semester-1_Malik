...
CREATE TABLE `mengambil` (
  ...
  `tanggal&waktu` varchar(45) DEFAULT NULL,
...
LOCK TABLES `mengambil` WRITE;
/*!40000 ALTER TABLE `mengambil` DISABLE KEYS */;
/*!40000 ALTER TABLE `mengambil` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-10-19 16:30:37
